import { AnimationClip, AnimationMixer, AnimationUtils, PropertyBinding } from 'three';
...
const TimelinerController = function TimelinerController( scene, trackInfo, onUpdate ) {
...
export default TimelinerController;
